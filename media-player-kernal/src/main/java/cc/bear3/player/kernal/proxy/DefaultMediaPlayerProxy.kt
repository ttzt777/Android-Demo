...
open class DefaultMediaPlayerProxy(
    ...
    override fun prepareMediaSource(source: MediaSource) {
    ...
    /**
     * 当一个循环播放的多媒体，结束当次播放会调用（reason==Player.DISCONTINUITY_REASON_AUTO_TRANSITION)
     */
    override fun onPositionDiscontinuity(
        ...
        Timber.d("On player position discontinuity -- reason($reason)")
    }
